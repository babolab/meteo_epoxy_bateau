...
params = {
    ...
    "forecast_days": 4,  # Arpège a une prévision plus courte que ECMWF
    "timezone": "auto"
}
...
if response.status_code == 200:
    ...
    if not result.empty:
        print("\nPrévisions Arpège - Créneaux où T° ≥ 10°C et point de rosée ≤ T°-3°C")
        print("================================================================")
        ...
        print("\nAucune correspondance trouvée pour 10°C avec Arpège.")
else:
